---
description: Plan and execute migration to @thegpvc/ui design system components
---

You are helping migrate an existing React application to use TheGP's @thegpvc/ui design system.
...
1. **Audit Current UI**: Analyze the existing codebase to identify:
   ...
   - Inline Tailwind styling that could use @thegpvc/ui components
   - Color values that should use @thegpvc/ui theme tokens
   - Custom icons that could be replaced with @thegpvc/ui icon exports
...
2. **Create Migration Plan**: Generate a detailed plan that includes:
   ...
   - Mapping of current components to @thegpvc/ui equivalents
...
3. **Implementation Strategy**:
   ...
   - Replace custom styling with @thegpvc/ui variants and props
...
- Use @thegpvc/ui variants (primary, secondary, ghost, etc.) instead of custom styles
